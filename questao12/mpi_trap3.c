...
int main(int argc, char* argv[]) {
    ...
    a = 0.0;  // Example value, change as needed
    b = 1.0;  // Example value, change as needed
    ...
    /* Reduce to find the maximum elapsed time */
    ...
    if (my_rank == 0) {
        ...
        printf("Maximum computation time across all processes = %f seconds.\n", max_elapsed);
    }
